...
val `scala3-compiler-py-bootstrapped` = Build.`scala3-compiler-py-bootstrapped`
...
// Self-contained Python-backend pattern benchmarks (language patterns, not stdlib).
val `bench-py` = Build.`bench-py`
