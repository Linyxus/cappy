...
object DoubleBuffer {
  private final val HashSeed = 2140173175
...
abstract class DoubleBuffer private[nio] (
  ...
  @inline final def array(): Array[Double] =
    GenBuffer(this).generic_array().asInstanceOf[Array[Double]]

  @inline final def arrayOffset(): Int =
    GenBuffer(this).generic_arrayOffset()

  @inline override def position(newPosition: Int): DoubleBuffer = { super.position(newPosition); this }
  @inline override def limit(newLimit: Int): DoubleBuffer = { super.limit(newLimit); this }
  @inline override def mark(): DoubleBuffer = { super.mark(); this }
  @inline override def reset(): DoubleBuffer = { super.reset(); this }
  @inline override def clear(): DoubleBuffer = { super.clear(); this }
  @inline override def flip(): DoubleBuffer = { super.flip(); this }
  @inline override def rewind(): DoubleBuffer = { super.rewind(); this }
  ...
  @inline
  private[nio] def load(startIndex: Int, dst: Array[Double], offset: Int, length: Int): Unit =
    GenBuffer(this).loadInto(startIndex, dst, offset, length)

  @inline
  private[nio] def store(startIndex: Int, src: Array[Double], offset: Int, length: Int): Unit =
