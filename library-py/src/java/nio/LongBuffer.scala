...
object LongBuffer {
  private final val HashSeed = -1709696158
...
abstract class LongBuffer private[nio] (
  ...
  @inline final def array(): Array[Long] =
    GenBuffer(this).generic_array().asInstanceOf[Array[Long]]

  @inline final def arrayOffset(): Int =
    GenBuffer(this).generic_arrayOffset()

  @inline override def position(newPosition: Int): LongBuffer = { super.position(newPosition); this }
  @inline override def limit(newLimit: Int): LongBuffer = { super.limit(newLimit); this }
  @inline override def mark(): LongBuffer = { super.mark(); this }
  @inline override def reset(): LongBuffer = { super.reset(); this }
  @inline override def clear(): LongBuffer = { super.clear(); this }
  @inline override def flip(): LongBuffer = { super.flip(); this }
  @inline override def rewind(): LongBuffer = { super.rewind(); this }
  ...
  @inline
  private[nio] def load(startIndex: Int, dst: Array[Long], offset: Int, length: Int): Unit =
    GenBuffer(this).loadInto(startIndex, dst, offset, length)

  @inline
  private[nio] def store(startIndex: Int, src: Array[Long], offset: Int, length: Int): Unit =
